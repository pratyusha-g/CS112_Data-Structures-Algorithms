...
public class ArrayList implements List {
    ...
    public ListIterator iterator() {
    	...
    	//takes item and removes all occurrences of that item from the list
    	//if one of more occurrences of item are removed, method should return true
    	//if no occurrences, return false
    	//run on time and use o1 memory
    	//no extraneous references to objects in the array
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(list1);
    	//System.out.println(list1.removeAll("b"));
